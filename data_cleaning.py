...
df = pd.read_csv('C:\\Users\\anny_\\Documents\\The_Glassdoor_Project\\input_glassdoor.csv')    
...
min_hr = minus_Kd.apply(lambda x: x.lower().replace('per hour', '').replace('employer provided', ''))
...
df.to_excel("C:\\Users\\anny_\\Documents\\The_Glassdoor_Project\\input_glassdoor.xlsx")
